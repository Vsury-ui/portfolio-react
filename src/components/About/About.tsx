...
import profileImage from "../../assets/v-profile-image.jpg";
    ...
    <Container id="sobre">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.2 * 1000}>
          <p>My name is Vivek Suryawanshi, I'm a computer technician with a great passion for programming. I am passionate about delivering solutions that add to people's lives and at the same time challenge me. Improved my skills as a Front-End and Back-End developer</p>
        </ScrollAnimation>
